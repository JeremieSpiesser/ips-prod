...
int main()
{
        ...
        std::cout << "    -=-=[ Launching calculus of a local nuclear density ]=-=-" << std::endl;
        Poly pol;
        ...
        std::cout << std::endl << "    -=-=[ Launching a second calculus more precise for the 2D display ]=-=-" << std::endl;
        ...
        std::cout << std::endl << "Calculus successfully ended !" << std::endl;
